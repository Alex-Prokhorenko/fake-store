...
export const products: productModel[] = [
    ...
    },
    {
        ...
        "description":"Slim-fitting style, contrast raglan long sleeve, three-button henley placket, " +
            "light weight & soft fabric for breathable and comfortable wearing. And Solid stitched shirts" +
            "with round neck made for durability and a great fit for casual fashion wear and diehard baseball fans. " +
